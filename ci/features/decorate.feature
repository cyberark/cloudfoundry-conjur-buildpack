Feature: Decorate script
  ...
  @BUILD_DIR
  Scenario: When conditions are met the decorate script returns a zero exit status
  ...
  @BUILD_DIR
  Scenario: When conditions are not met the decorate script returns a non-zero exit status
